...
/* ─────────────────────────────────────────────────────
   Error Boundary — shows error text instead of blank
───────────────────────────────────────────────────── */
    ...
    if (this.state.error) {
      return (
        <div style={{ padding: 24, fontFamily: 'monospace', maxWidth: 430, margin: '0 auto' }}>
          <h2 style={{ color: '#dc2626', marginBottom: 12, fontFamily: 'sans-serif' }}>Something went wrong</h2>
          <pre style={{ background: '#fee2e2', padding: 12, borderRadius: 8, fontSize: 11, overflowX: 'auto', whiteSpace: 'pre-wrap', wordBreak: 'break-all' }}>
          ...
          <button
            ...
            style={{ marginTop: 16, padding: '10px 24px', background: '#0A1628', color: '#fff', borderRadius: 10, border: 'none', cursor: 'pointer', fontWeight: 700 }}
          >
            Reload App
          </button>
        </div>
...
/* ─────────────────────────────────────────────────────
   Per-page error boundary (isolates crashes per route)
───────────────────────────────────────────────────── */
...
/* ─────────────────────────────────────────────────────
   Global toast + sidebar (rendered once, above all pages)
───────────────────────────────────────────────────── */
